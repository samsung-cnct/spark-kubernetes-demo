...
kubectl.sh create -f spark-hdfs-master-service.yaml
kubectl.sh create -f spark-hdfs-master-controller.yaml
...
printf "\nStart spark-worker...\n"
kubectl.sh create -f spark-hdfs-worker-controller.yaml
kubectl.sh get pods
